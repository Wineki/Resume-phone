	...
	$.fn.fullpage = function(options) {
		...
		*/
		...
		function addTableClass(element){
			// if (element.attr("id")==="section3") {
				element.addClass('fp-table').wrapInner('<div class="fp-tableCell" style="height:' + getTableHeight(element) + 'px;" />');
			// }else{
				
			// }
			
			// element.addClass('fp-table').wrapInner('<div class="fp-tableCell" style="height: 100%" />');
		}
		...
		*/
		function addSlidesNavigation(section, numSlides){
			if (section.attr("id") === "section3") {
				...
				nav_ul = nav.find("ul");
				nav_ul.append('<li><a href="#"><span><img src="web_images/pos_1.png" alt=""></span></a></li>');
				nav_ul.append('<li><a href="#"><span><img src="web_images/pos_0.png" alt=""></span></a></li>');
				nav_ul.append('<li><a href="#"><span><img src="web_images/pos_2.png" alt=""></span></a></li>');
				nav_ul.append('<li><a href="#"><span><img src="web_images/pos_3.png" alt=""></span></a></li>');
				nav_ul.append('<li><a href="#"><span><img src="web_images/pos_4.png" alt=""></span></a></li>');
